...
Usage:
    python sexdiff_analysis.py [--umap-clusters umap_clusters.csv] [--genotype Rye] [--output-dir analysis_results/sexdiff]
"""
...
def load_feature_data(input_file):
    """Load ML features Z-scored data."""
...
Examples:
  ...
  python sexdiff_analysis.py --genotype Rye
  python sexdiff_analysis.py --umap-clusters analysis_results/umap/umap_clusters.csv --genotype Fmn
  python sexdiff_analysis.py --genotype All  # Run for all genotypes with both sexes
        """
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='Input ML_features_Z.csv file (default: auto-detect in data/processed/)'
    )
    ...
    if args.input is None:
        ...
        if default_input.exists():
            ...
            print("Error: Could not auto-detect ML_features_Z.csv")
            print(f"  Expected at: {default_input}")
    ...
    df = load_feature_data(args.input)
