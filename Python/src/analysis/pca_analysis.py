...
Usage:
    python pca_analysis.py [--input ML_features_Z.csv] [--output-dir plots/]
"""
...
def run_pca(df_veh, output_dir):
    ...
    # Extract z-scored features only
    meta_cols = ['fly_id', 'Genotype', 'Sex', 'Treatment']
    z_cols = [col for col in df_veh.columns if col.endswith('_Z')]
...
Examples:
  ...
  python pca_analysis.py --input data/processed/ML_features_Z.csv
  python pca_analysis.py --input ML_features_Z.csv --output-dir analysis_results/pca
        """
    )
