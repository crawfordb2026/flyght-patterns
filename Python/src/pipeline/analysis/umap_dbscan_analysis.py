...
Usage:
    python umap_dbscan_analysis.py [--input ML_features_Z.csv] [--output-dir analysis_results/umap]
"""
...
Examples:
  ...
  python umap_dbscan_analysis.py --input data/processed/ML_features_Z.csv
  python umap_dbscan_analysis.py --input ML_features_Z.csv --output-dir umap_results/
        """
    )
